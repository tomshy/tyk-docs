...
2.  Swagger/OpenAPI - either by pasting your Swagger/OpenAPI JSON content into the code editor, or by linking to any public facing Swagger/OpenAPI JSON URL. The URL version can be rendered using [Swagger UI](https://swagger.io/tools/swagger-ui/) which offers a sandbox environment where developers can interact with your API from the browser.
